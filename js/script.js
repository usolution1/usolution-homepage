document.addEventListener('DOMContentLoaded', () => {
    ...
    /* --- Generalized Modal Handling --- */
    const openBtns = document.querySelectorAll('.open-modal-btn');
    const closeBtns = document.querySelectorAll('.modal-close');
    const modals = document.querySelectorAll('.modal-overlay');
    const switchBtns = document.querySelectorAll('.switch-modal-btn'); // For switching from detail to contact

    openBtns.forEach(btn => {
        btn.addEventListener('click', (e) => {
            e.preventDefault();
            const targetId = btn.getAttribute('data-target') || 'contactModal';
    ...
    modals.forEach(modal => {
        modal.addEventListener('click', (e) => {
            // Only click on the dark overlay area closes it
            if (e.target === modal) {
